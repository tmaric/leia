...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
SDPLS_lin::SDPLS_lin(const dictionary& dict, const fvMesh& mesh)
    :
...
tmp<volScalarField> SDPLS_lin::nonLinearPart(const volScalarField& R, const volScalarField& psi, const volVectorField& U) const
{
